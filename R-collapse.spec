...
Version  : 1.8.9
Release  : 11
URL      : https://cran.r-project.org/src/contrib/collapse_1.8.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/collapse_1.8.9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665424375
