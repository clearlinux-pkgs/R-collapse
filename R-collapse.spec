...
Version  : 1.9.4
Release  : 17
URL      : https://cran.r-project.org/src/contrib/collapse_1.9.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/collapse_1.9.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680535232
