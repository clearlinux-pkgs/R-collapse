...
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/collapse_2.1.1.tar.gz
...
statistical computing in R that is extremely fast, class-agnostic, robust, and 
    ...
    It seamlessly supports base R objects/classes as well as 'units', 'integer64', 
    'xts'/'zoo', 'tibble', 'grouped_df', 'data.table', 'sf', 'pseries'/'pdata.frame'.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744670133
